      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <p className="section-subtitle">
            Starting rates for common jobs. Your final quote depends on size, level, and add-ons — get an instant estimate online.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-3">
          <section className="card p-6">
            ...
            <Link href="/residential-cleaning" className="mt-6 inline-flex text-sm font-semibold text-[#FF7A00] hover:underline">
          ...
          <section className="card p-6">
            ...
            <Link href="/commercial-cleaning" className="mt-6 inline-flex text-sm font-semibold text-[#FF7A00] hover:underline">
          ...
          <section className="card p-6">
            ...
            <ul className="mt-6 space-y-3 text-sm text-slate-700">
              {Object.entries(basePost).map(([key, price]) => (
                <li key={key} className="flex justify-between border-b border-slate-100 pb-2">
                  <span>{key.replace("under1k", "Under 1k sqft").replace("1k-2k", "1k–2k sqft").replace("over2k", "2k+ sqft")}</span>
                  <span className="font-semibold text-[#FF7A00]">from ${price}</span>
                </li>
              ))}
            </ul>
            <Link href="/post-construction-cleaning" className="mt-6 inline-flex text-sm font-semibold text-[#FF7A00] hover:underline">
