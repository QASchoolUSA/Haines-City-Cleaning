...
export default function CommercialCleaningContent() {
  return (
    <div className="prose prose-lg mx-auto text-slate-600 prose-headings:text-[#FF7A00] prose-a:text-[#FF7A00] prose-strong:text-slate-900 prose-ul:list-disc prose-ul:pl-6">
      ...
      <ul>
        <li><strong>Office Cleaning:</strong> We offer daily, weekly, and bi-weekly office cleaning services to keep your workspace clean and organized.</li>
        <li><strong>Janitorial Services:</strong> Our janitorial services include everything from trash removal to restroom sanitation, ensuring a clean and healthy environment for your employees and customers.</li>
        <li><strong>Retail Cleaning:</strong> We understand the importance of a clean and inviting retail space. Our retail cleaning services will help you attract and retain customers.</li>
