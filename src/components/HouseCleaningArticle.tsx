      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="prose prose-slate mt-10 max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-headings:text-slate-900 prose-p:leading-relaxed prose-p:text-slate-600 prose-strong:text-slate-800">
            ...
            <p>
              Our <strong>Haines City house cleaning</strong> services are tailored to meet your specific needs. We offer a range of services,
              from regular maintenance cleaning to deep cleaning and move-in/move-out cleaning. Our team of experienced and vetted cleaners
              uses high-quality, eco-friendly products to ensure the safety of your family and pets. We pride ourselves on our attention
              to detail and our commitment to customer satisfaction.
            </p>
            <p>
