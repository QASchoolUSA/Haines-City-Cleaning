...
export default function HouseCleaningArticle() {
  return (
    <section className="relative bg-linear-to-b from-[#FFB730]/10 via-white to-white py-24 sm:py-32">
      <div className="absolute inset-x-0 top-0 -z-10 h-px bg-linear-to-r from-transparent via-[#FFB730]/20 to-transparent" />
