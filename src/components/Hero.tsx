        ...
        <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:gap-14">
          <div className="max-w-xl lg:pt-2">
            ...
            <p className="mt-6 text-lg leading-relaxed text-slate-600">
              Trusted <strong className="font-semibold text-slate-800">Haines City Cleaning</strong>{" "}
              services for residential, commercial, and post‑construction needs. We are your local
              experts for{" "}
              <strong className="font-semibold text-slate-800">house cleaning in Haines City, FL</strong>.
            </p>
