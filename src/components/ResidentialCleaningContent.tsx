...
export default function ResidentialCleaningContent() {
  return (
    <div className="prose prose-lg mx-auto text-slate-600 prose-headings:text-[#FF7A00] prose-a:text-[#FF7A00] prose-strong:text-slate-900 prose-ul:list-disc prose-ul:pl-6">
      ...
      <ul>
        <li><strong>Standard Cleaning:</strong> Our standard cleaning service is perfect for keeping your home in top shape on a regular basis. We'll clean your kitchen, bathrooms, bedrooms, and living areas, so you can always come home to a fresh and tidy space.</li>
        <li><strong>Deep Cleaning:</strong> Our deep cleaning service is a more thorough version of our standard cleaning. We'll get into all the nooks and crannies, cleaning everything from the inside of your oven to the tops of your ceiling fans.</li>
        <li><strong>Move-In/Move-Out Cleaning:</strong> Moving can be a stressful experience, but our move-in/move-out cleaning service can make it a little easier. We'll clean your old home from top to bottom, so you can get your security deposit back, and we'll clean your new home, so you can start fresh in a spotless space.</li>
      ...
      <ul>
        <li><strong>Experienced and Vetted Cleaners:</strong> Our team of cleaners is experienced, professional, and thoroughly vetted. You can trust us to treat your home with the care and respect it deserves.</li>
        <li><strong>Eco-Friendly Products:</strong> We use high-quality, eco-friendly cleaning products that are safe for your family and pets. We believe in protecting the environment while providing a top-notch cleaning service.</li>
        <li><strong>Flexible Scheduling:</strong> We offer flexible scheduling to fit your busy lifestyle. Whether you need a one-time clean or a recurring service, we can work with you to find a time that is convenient for you.</li>
