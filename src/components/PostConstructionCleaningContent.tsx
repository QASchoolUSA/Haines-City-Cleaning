...
export default function PostConstructionCleaningContent() {
  return (
    <div className="prose prose-lg mx-auto text-slate-600">
      ...
      <ul>
        <li><strong>Debris Removal:</strong> We'll remove all construction debris, including dust, dirt, and leftover materials.</li>
        <li><strong>Detailed Cleaning:</strong> We'll perform a detailed cleaning of the entire space, including washing walls, cleaning windows, and polishing fixtures.</li>
      ...
      <ul>
        <li><strong>Experienced and Trained Team:</strong> Our team is trained to handle the specific challenges of post-construction cleaning.</li>
        <li><strong>Specialized Equipment:</strong> We use specialized equipment to ensure a thorough and efficient cleaning.</li>
